...
TOP_K_EVIDENCE_CHUNKS = 6                 # evidence chunks for REPORT
CHUNK_SIZE = 1200
CHUNK_OVERLAP = 150
...
CHAT_RETRIEVER_TOP_K = 18
CHAT_TOP_K_PAGES = 10
CHAT_TOP_K_EVIDENCE_CHUNKS = 8

# Industry intent gate settings
...
def title_score(title: str, user_industry: str) -> float:
    """
    Improved scoring that is robust to hyphens/spacing:
    - 'kpop' matches 'K-pop'
    """
...
with st.form("industry_form"):
    industry_input = st.text_input("Industry", placeholder="e.g. video game industry / kpop industry")
